            ...
            Container(
                decoration: const BoxDecoration(
                  ...
                  image: DecorationImage(
                      image: AssetImage("assets/images/gpaCalculatorShils.png"),
                      fit: BoxFit.cover,
                                ...
                                Container(
                                  child: Row(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            SizedBox(height: constraints.maxHeight * 7 / 852),
                                      ...
                                      //Grade Column
                                      SizedBox(width:constraints.maxWidth * 23 / 393),
                                      Container(
                                        child: Column(
                                          mainAxisSize: MainAxisSize.min,
                                          mainAxisAlignment:
                                          ...
                                          children: [
                                            ...
                                            Container(
                                              padding: EdgeInsets.symmetric(
                                                  horizontal:
                                                      constraints.maxWidth * 5 / 393,
                                                  vertical:
                                                      constraints.maxHeight * 3 / 852),
                                              decoration: ShapeDecoration(
                                                color:const Color(0xFFF5CEC7),
                                                shape: RoundedRectangleBorder(
                                                  borderRadius:
                                  ...
                                  Container(
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        //Pre S/U
                                        SizedBox(width: constraints.maxWidth * 70 / 393),
                                        Container(
                                          child: Row(
                                            mainAxisSize: MainAxisSize.min,
                                            mainAxisAlignment: MainAxisAlignment.start,
